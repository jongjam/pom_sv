<script>
    ...
    //Put the time button or put something here to indicate that clicking on start studying in Time goes to the Pomodoro
    
    function goToPomodoro() { // send this on click signal to the main page
